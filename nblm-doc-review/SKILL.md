...
This skill queries your NotebookLM notebooks at `/path/to/notebooklm/` and reads your notebook library at `/path/to/notebooklm/data/library.json`.
...
2. Authenticate: `cd /path/to/notebooklm && python3 scripts/run.py auth_manager.py setup`
3. Add notebooks: `python3 scripts/run.py notebook_manager.py add --url <url> --name <name> --description <desc> --topics <topics>`

**How It Works:**
- This skill calls NotebookLM scripts at `/path/to/notebooklm/scripts/`
- Reads notebook library at `/path/to/notebooklm/data/library.json`
- Uses NotebookLM's browser automation to query your notebooks

**Notebook Library Location:**
```
/path/to/notebooklm/data/library.json
```
...
- Check NotebookLM library has notebooks: `cd /path/to/notebooklm && python3 scripts/run.py notebook_manager.py list`
...
**Solution:**
- Check NotebookLM authentication: `cd /path/to/notebooklm && python3 scripts/run.py auth_manager.py status`
